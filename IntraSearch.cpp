...
IntraSearch::IntraSearch(const Instance &instance) : W(instance.getW()), generator((random_device()) ()), searchOrder(N_INTRA_SEARCHES) {
...
void IntraSearch::shuffleSearchOrder() {
