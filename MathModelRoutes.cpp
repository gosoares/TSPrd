...
void MathModelRoutes::getA(vector<vector<int>> &a){
    int lenRoute = 0;
...
vector<vector<unsigned int>*> MathModelRoutes::addConstraints(vector<vector<int>> a){
    IloEnv env;
    IloModel model(env);
